...
export class AutoCompleteInput extends React.Component<IAutoCompleteInputProps & IFormBinding, IAutoCompleteInputState> {
  ...
  componentWillMount() {
    ...
    if (this.props.data[this.props.prop]) {
      if (this.props.multiSelect) {
        if (_.isArray(this.props.data[this.props.prop])) {
          selectedValue = this.props.data[this.props.prop];
        } else {
          selectedValue = [this.props.data[this.props.prop]];
        }
      } else {
  ...
  componentWillReceiveProps(newProps: IAutoCompleteInputProps & IFormBinding) {
    if (this.props.multiSelect) {
      ...
      var newSingleValue = newProps.data[newProps.prop] as IAutoCompleteOption;
  ...
  change(value: IAutoCompleteOption[] | IAutoCompleteOption){
    Binder.handleChange(this.props.prop, value, "select", this.props.data);
