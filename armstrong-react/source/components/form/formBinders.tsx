...
export class InputFormBinder<TDataPropValue, TComponentPropValue> extends FormBinderBase<
   React.DOMAttributes<{}>,
   TDataPropValue,
   TComponentPropValue
> {
...
class ChildrenBinder<TValue, TProps = HTMLElement> implements IFormBinder<TProps, any> {
   constructor(
      ...
      private childrenFactory: (value: TValue, props?: TProps, dataBinder?: IDataBinder<any>) => React.ReactNode
   ) {}
...
export class FormBinder<TDataBinder> {
   ...
   children<TValue, TProps = HTMLElement>(
      dataName: FormBinderKey<TDataBinder>,
      childrenFactory: (value: TValue, props?: TProps, dataBinder?: IDataBinder<any>) => React.ReactNode
   ) {
   ...
   private defaultInputFormBinder<TDataPropValue, TTo>(
      dataName: FormBinderKey<TDataBinder>,
      type: string,
      valueConverter?: IValueConverter<TDataPropValue, TTo>,
      propertySet = "value"
   ) {
