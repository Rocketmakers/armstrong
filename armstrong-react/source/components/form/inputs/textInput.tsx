...
import { IconOrJsx, getIconOrJsx } from "./../../display/icon";
...
> = (props, ref) => {
  ...
  const classes = React.useMemo(
    () =>
      ClassHelpers.classNames("armstrong-input", "text-input", className, {
  ...
  return (
    <div className={classes} title={validationMessage}>
      ...
      {rightOverlayText && (
        <div className="input-overlay-text-right">{rightOverlayText}</div>
      )}
      {rightIcon && getIconOrJsx(rightIcon, { className: "right-icon" })}
      {children}
