...
const RadioListInputRef: React.ForwardRefRenderFunction<IRadioListInput, IRadioListInputProps> = (props, ref) => {
  ...
  const classes = React.useMemo(
    () =>
      ClassHelpers.classNames("armstrong-input", "radio-list", props.className, {
...
> = (p) => {
  ...
  return (
    <div className="radio-option">
      ...
      <label className="radio-label" htmlFor={autoId}>
        {labelContent}
      </label>
    </div>
  );
